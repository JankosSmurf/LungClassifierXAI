...
def shap_4_outs_explainer(sample_to_explain, evaluation_limit):
    classifier_wrapper = TorchModelWrapper(NewClassifyNet4, 'weights/new_classify2d_4_outs.ckpt', device='cpu')
    classifier_wrapper.fit()
...
def shap_16_outs_explainer(sample_to_explain, evaluation_limit):
    classifier_wrapper = TorchModelWrapper(ClassifyNet16, 'weights/old_classify2d_16_outs.ckpt', device='cpu')
    classifier_wrapper.fit()
...
def shap_5_outs_explainer(sample_to_explain, evaluation_limit):
    classifier_wrapper = TorchModelWrapper(NewClassifyNet, 'weights/new_classify2d.ckpt', device='cpu')
    classifier_wrapper.fit()
...
def shap_17_outs_explainer(sample_to_explain, evaluation_limit):
    classifier_wrapper = TorchModelWrapper(ClassifyNet, 'weights/classify2d.ckpt', device='cpu')
    classifier_wrapper.fit()
...
def shap_6_outs_explainer(sample_to_explain, evaluation_limit):
    classifier_wrapper = TorchModelWrapper(NewClassifyNet6, 'weights/newest_classify2d_6_outs.ckpt', device='cpu')
    classifier_wrapper.fit()
...
def shap_6_ones_outs_explainer(sample_to_explain, evaluation_limit):
    classifier_wrapper = TorchModelWrapper(NewClassifyNet6, 'weights/newest_classify2d_ones_6_outs.ckpt', device='cpu')
    classifier_wrapper.fit()
...
def shap_8_outs_explainer(sample_to_explain, evaluation_limit):
    classifier_wrapper = TorchModelWrapper(NewClassifyNet8, 'weights/new_classify2d_8_outs.ckpt', device='cpu')
    classifier_wrapper.fit()
...
def main():
    ...
    if explainer_type == 2:
        evaluation_limit = int(input(
            "How many evaluations do you want shap explainer to perform? \nThe more evaluations the more detailed explanation \n 10000 evaluations takes ~20 seconds and 100000 takes ~3 minutes \nNumber of evaluations: "))
    ...
    if explainer_type == 1 and explainer_outs == 1:
        ...
        local_values_list, global_values_list, greens = shap_4_outs_explainer(sample_to_explain, evaluation_limit)
    elif explainer_type == 2 and explainer_outs == 2:
        local_values_list, global_values_list, greens = shap_16_outs_explainer(sample_to_explain, evaluation_limit)
    elif explainer_type == 2 and explainer_outs == 3:
        local_values_list, global_values_list, greens = shap_5_outs_explainer(sample_to_explain, evaluation_limit)
    elif explainer_type == 2 and explainer_outs == 4:
        local_values_list, global_values_list, greens = shap_17_outs_explainer(sample_to_explain, evaluation_limit)
    elif explainer_type == 2 and explainer_outs == 5:
        local_values_list, global_values_list, greens = shap_6_outs_explainer(sample_to_explain, evaluation_limit)
    elif explainer_type == 2 and explainer_outs == 6:
        local_values_list, global_values_list, greens = shap_6_ones_outs_explainer(sample_to_explain, evaluation_limit)
    elif explainer_type == 2 and explainer_outs == 7:
        local_values_list, global_values_list, greens = shap_8_outs_explainer(sample_to_explain, evaluation_limit)
