...
def slider_window_4_images(lung_image, local_values, global_values, greens):
    ...
    def overlay_mask(image, mask, alpha, coefficient):
        ...
        color_mask = cmap(recalculated_mask)
...
def slider_window_16_images(lung_image, local_values, global_values, greens):
    def crazy_function(array, coefficient):
        if coefficient == 0:
            return array
        else:
...
def slider_window_6_images(lung_image, local_values, global_values, greens):
    def crazy_function(array, coefficient):
        if coefficient == 0:
            return array
        else:
...
def slider_window_8_images(lung_image, local_values, global_values, greens):
    def crazy_function(array, coefficient):
        if coefficient == 0:
            return array
        else:
...
def main():
    ...
    # Display
    if explainer_outs == 5:
        slider_window_6_images(sample_to_display, local_values_list, global_values_list, greens)
    elif explainer_outs == 6:
        slider_window_6_images(sample_to_display, local_values_list, global_values_list, greens)
    elif explainer_outs == 7:
        slider_window_8_images(sample_to_display, local_values_list, global_values_list, greens)
    elif explainer_outs%2 == 0:
        slider_window_16_images(sample_to_display, local_values_list, global_values_list, greens)
    else:
        slider_window_4_images(sample_to_display, local_values_list, global_values_list, greens)
